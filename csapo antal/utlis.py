        ...
        for d in range(rows):
            for c in range(cols):
                cv2.rectangle(ver, (c * eachImgWidth, eachImgHeight * d),
                              (c * eachImgWidth + 120, 30 + eachImgHeight * d), (255, 255, 255), cv2.FILLED)
                cv2.putText(ver, labels[d][c], (c * eachImgWidth + 10, eachImgHeight * d + 20),
...
def initializeTrackbars(initialVals=0):
